...
t.call(this,g);g.appendChild(d);document.body.appendChild(g);F.call(this,a,d,f,null,!0)}}function u(a){var b={},c=document.body,d=document.documentElement,e=window.pageYOffset||d.scrollTop||c.scrollTop,c=window.pageXOffset||d.scrollLeft||c.scrollLeft;if(a instanceof SVGElement)a=a.getBoundingClientRect(),b.top=a.top+e,b.width=a.width,b.height=a.height,b.left=a.left+c;else{b.width=a.offsetWidth;b.height=a.offsetHeight;c=e=0;for(d=a;d&&!isNaN(d.offsetLeft)&&!isNaN(d.offsetTop);)e+=d===a?d.offsetLeft:
d.offsetLeft+d.clientLeft,c+=d===a?d.offsetTop:d.offsetTop+d.clientTop,d=d.offsetParent;b.top=c;b.left=e}return b}function Q(){return 100*(parseInt(this._currentStep+1,10)/this._introItems.length)}var M=function(a){if("object"===typeof a)return new m(a);if("string"===typeof a){if(a=document.querySelector(a))return new m(a);throw Error("There is no element with given selector.");}return new m(document.body)};M.version="2.5.0";M.fn=m.prototype={clone:function(){return new m(this)},setOption:function(a,
